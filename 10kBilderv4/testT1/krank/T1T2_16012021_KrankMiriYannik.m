...
for i=1:100             % Anzahl der Durchläufe pro Durchlauf 1xT1 und 1xT2 
...
T1_Tum = (rand(1)*(1.75-2.1)+2.1);   % 0.926;  CraPHA
...
T2_Tum = (rand(1)*(0.3-0.32)+0.32);      % 0.12; 
